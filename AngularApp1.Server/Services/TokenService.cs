...
public class TokenService(IConfiguration configuration, TokenStore tokenStore)
{
    ...
    private readonly string? _salesforceClientSecret = configuration["LoginProd:ServerPfx"];
    private readonly string? _salesforceCertificatePw = configuration["LoginProd:Password"];
